...
import frntr from '../../../assets/frntr.jpg'
...
const HomeAplncs = () => {
  ...
  useEffect(()=>{
    axios.get("https://ecom-server-ykfk.onrender.com/api/products/home_aplncs")
    .then((response)=>{
    ...
    <div className='product'>
      ...
      <div className='pdct-rightPart'>
        <div className='pdct-poster'>
          <img src={frntr} alt='Mobile Poster'/>
        </div>
