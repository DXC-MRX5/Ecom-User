...
import wntr from '../../../assets/wntr.jpg';
...
const Wwinter = () => {
  ...
  useEffect(()=>{
    axios.get("https://ecom-server-ykfk.onrender.com/api/products/wmn_wntrwear")
    .then((response)=>{
    ...
    <div className='product'>
      ...
      <div className='pdct-rightPart'>
        <div className='pdct-poster'>
          <img src={wntr} alt='Laptop Poster'/>
        </div>
