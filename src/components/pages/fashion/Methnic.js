...
import mfsn from '../../../assets/mfsn.jpg';
...
const Methnic = () => {
  ...
  useEffect(()=>{
    axios.get("https://ecom-server-ykfk.onrender.com/api/products/men_ethnic")
    .then((response)=>{
    ...
    <div className='product'>
      ...
      <div className='pdct-rightPart'>
        <div className='pdct-poster'>
          <img src={mfsn} alt='Laptop Poster'/>
        </div>
