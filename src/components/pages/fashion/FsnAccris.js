...
import fsnac from '../../../assets/fsnac.jpeg'
...
const FsnAccris = () => {
  ...
  useEffect(()=>{
    axios.get("https://ecom-server-ykfk.onrender.com/api/products/fsn_accsris")
    .then((response)=>{
    ...
    <div className='product'>
      ...
      <div className='pdct-rightPart'>
        <div className='pdct-poster'>
          <img src={fsnac} alt='Mobile Poster'/>
        </div>
